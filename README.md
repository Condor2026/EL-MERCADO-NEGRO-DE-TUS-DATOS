...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Módulos-20%20de%2050-orange?style=for-the-badge" alt="Módulos">
</p>
...
|--------|---------------------|
| 👨‍👩‍👧‍👦 **Familias** | Proteger a tus padres, hijos y pareja de estafas |
| 💼 **Autónomos y profesionales** | Evitar que un ciberataque arruine tu negocio |
| 📱 **Usuarios normales** | No ser la próxima víctima de phishing o robo de cuentas |
| 🕵️ **Activistas y periodistas** | Proteger tu identidad y tu trabajo |
| 🧠 **Curiosos digitales** | Entender cómo funciona el lado oscuro de internet |

---

## 📚 Módulos disponibles

### 🟢 Serie Ciudadano (Protección Personal)
...
| **4** | [Análisis de malware para no expertos](modulo-4-malware/) | Detecta amenazas sin ser técnico | ✅ Publicado |
| **5** | [Protección contra doxxing](modulo-5-doxxing/) | Evita que publiquen tus datos privados | ✅ Publicado |
| **6** | [OpSec para personas normales](modulo-6-opsec/) | Seguridad operativa sin paranoia | ✅ Publicado |
...
### 👨‍👩‍👧‍👦 Con tu familia
1. Usa las **simulaciones formativas** para practicar juntos.
2. Imprime el **póster de la nevera** con las reglas de oro.
3. Establece un **código secreto familiar**.

### 🏢 En tu trabajo o comunidad
1. Comparte los módulos en tu grupo de WhatsApp o Telegram.
2. Organiza una **charla de 30 minutos** con un módulo como base.
3. Usa los **ejercicios prácticos** como dinámicas de grupo.

---

## 🎓 Metodología

Cada módulo sigue una estructura probada:

| Fase | Descripción |
|------|-------------|
| 📖 **Historia real** | Un caso anonimizado que engancha y muestra el peligro real |
| 🧠 **Conceptos clave** | Explicación clara, sin tecnicismos innecesarios |
| 🔍 **Métodos de ataque** | Cómo operan los criminales (para que puedas reconocerlos) |
| 🛡️ **Estrategias defensivas** | Acciones concretas que puedes aplicar hoy |
| 📋 **Listas de verificación** | Para imprimir y tener a mano |
| 🎯 **Ejercicios prácticos** | Para entrenar sin riesgo |
| 📚 **Recursos** | Herramientas gratuitas y enlaces útiles |
...
**⚠️ Este contenido tiene fines EXCLUSIVAMENTE EDUCATIVOS**

</div>

**Queda terminantemente prohibido** el uso de la información, técnicas o herramientas descritas en este proyecto para:

- ❌ Cometer delitos informáticos
- ❌ Robar, suplantar, extorsionar o dañar a terceros
...
El autor, **Condor2026**, **NO SE HACE RESPONSABLE** del mal uso que terceros puedan dar a este contenido. El lector asume toda la responsabilidad legal y ética de sus acciones.

📌 Consulta el [Código de Conducta](CODE_OF_CONDUCT.md) y la [Política de Seguridad](SECURITY.md) para más detalles.
...
### ❌ Restricciones
- **Atribución** — Debes reconocer los créditos del autor.
